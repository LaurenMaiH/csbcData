...
df = pd.read_csv('csbcData2022.csv')
...
# colsFix = ['MPER', 'MPIR', 'MPSTR', 'VPER', 'VPIR', 'VPSTR', 'PTR', 'GEMCER', 'GEMPER', 'GEMSTR', 'GEVCER', 'GEVPER', 'GEVSTR', 'GETR', 'PCR', 'PAR', 'PTR', 'PSTR', 'GCR', 'GAR', 'GTR', 'GSTR', 'STR', 'TotalRank', 'MPES', 'MPIS', 'MPSTS', 'VPES', 'VPIS', 'VPSTS', 'PTS', 'GEMCES', 'GEMPES', 'GEMSTS', 'GEVCES', 'GEVPES', 'GEVSTS', 'GETS', 'PCS', 'PAS', 'PTS', 'PSTS', 'GCS', 'GAS', 'GTS', 'GSTS', 'STS', 'T/P', 'TotalScore']
